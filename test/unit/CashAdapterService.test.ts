...
describe('CashAdapterService', () => {
    ...
    beforeEach(() => {
        ...
        cashAdapterService = new CashAdapterService(cashPaymentProcessor, MOCK_TRANSACTIONS);
    });
    ...
    describe('processPayment', () => {
        it('should return a successful payment response', () => {
            ...
            const response = cashAdapterService.processPayment(amount, paymentMethod, details);
